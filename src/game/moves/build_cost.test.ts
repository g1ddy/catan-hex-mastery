...
describe('Unit Test: Resource Costs', () => {
    ...
    describe('buildRoad', () => {
        it('should fail with zero resources', () => {
            const call = () => (buildRoad as unknown as MoveFn)({ G, ctx: mockContext }, validEdgeId);
    ...
    describe('buildSettlement', () => {
        it('should fail if missing sheep', () => {
            ...
            const call = () => (buildSettlement as unknown as MoveFn)({ G, ctx: mockContext }, validVertexId);
    ...
    describe('buildCity', () => {
        it('should fail if missing wheat', () => {
            ...
            const call = () => (buildCity as unknown as MoveFn)({ G, ctx: mockContext }, validVertexId);
