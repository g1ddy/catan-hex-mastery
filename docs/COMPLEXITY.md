...
| `src/features/board/components/HexOverlays.tsx` | **62.2** | 146 | 9 | 7 | 0.78 |
...
| `src/features/board/components/OverlayVertex.tsx` | **10** | 103 |
| `src/game/core/utils/sanitize.ts` | **10** | 73 |
| `src/bots/CatanBot.ts` | **9** | 112 |
| `src/features/coach/logic/coachUtils.ts` | **9** | 112 |
